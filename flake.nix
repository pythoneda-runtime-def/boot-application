...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-runtime-boot = {
      ...
      url = "github:pythoneda-runtime-def/boot/0.0.54";
    };
    pythoneda-runtime-boot-infrastructure = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-runtime-def/boot-infrastructure/0.0.54";
    };
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.6";
        sha256 = "15f6z7fzf39b66zcfdskdf1j6fx3yj2il104aigyl4dhwrgbblcv";
        pname = "${org}-${repo}";
