...
{
  description = "Nix flake for pythoneda-runtime/boot-application";
  inputs = rec {
    ...
    pythoneda-runtime-boot = {
      ...
      url = "github:pythoneda-runtime-def/boot/0.0.49";
    };
    pythoneda-runtime-boot-infrastructure = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-runtime-def/boot-infrastructure/0.0.48";
    };
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.4";
        sha256 = "0gbxa1xgqmip81vlws7vh08ri55agpb0izbia71d1zpmdw9i3rka";
        pname = "${org}-${repo}";
        ...
        pythoneda-runtime-boot-application-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-runtime-boot} ${pythoneda-runtime-boot-infrastructure} ${pythoneda-shared-pythonlang-application} ${pythoneda-shared-pythonlang-banner} ${pythoneda-shared-pythonlang-domain}; do
