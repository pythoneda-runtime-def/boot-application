...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-runtime-boot = {
      ...
      url = "github:pythoneda-runtime-def/boot/0.0.52";
    };
    pythoneda-runtime-boot-infrastructure = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-runtime-def/boot-infrastructure/0.0.52";
    };
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.5";
        sha256 = "0xh6yw34i02qv1l27apcfl3clxs4s5vhjysx7585i1i2w3a01bzn";
        pname = "${org}-${repo}";
